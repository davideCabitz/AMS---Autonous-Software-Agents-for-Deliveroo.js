...
export function buildSystemPrompt(objective) {
    ...
    return [
        ...
        '- patrol(x1,y1,x2,y2,wait_each): walk from (x1,y1) to (x2,y2) one tile at a time, pausing',
        '  wait_each seconds at EVERY tile — the whole sweep is ONE call. ALWAYS use this for',
        '  "keep moving until you reach ..." / "sweep/patrol the row" instead of many go_to+wait.',
